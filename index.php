...
<html>
	...
	<header id = "mainPageHead">
		<div id = "logo">
			<img src = "PRLogo.png" id="imgLogo"> 
		</div>
		<div id="mainPgLinks">
			<a href = "./form/login.php" class = "mainPgButton"> Login</a>
			<a href = "./form/signup.php" class = "mainPgButton">Sign Up </a>
		</div>
	</header>
	
	<div class = "movieSlide">
		<div class="moviePic">
		<img src="https://images-na.ssl-images-amazon.com/images/M/MV5BMDdmZGU3NDQtY2E5My00ZTliLWIzOTUtMTY4ZGI1YjdiNjk3XkEyXkFqcGdeQXVyNTA4NzY1MzY@._V1_SX300.jpg"/>
		</div>
		<div class="moviePic">
		<img src="https://images-na.ssl-images-amazon.com/images/M/MV5BYzQ2OTk4N2QtOGQwNy00MmI3LWEwNmEtOTk0OTY3NDk2MGJkL2ltYWdlL2ltYWdlXkEyXkFqcGdeQXVyNjc1NTYyMjg@._V1_SX300.jpg"/>
		</div>
		<div class="moviePic">
		<img src="https://images-na.ssl-images-amazon.com/images/M/MV5BNmFmZDdkODMtNzUyMy00NzhhLWFjZmEtMGMzYjNhMDA1NTBkXkEyXkFqcGdeQXVyNDUyOTg3Njg@._V1_SX300.jpg"/>
		</div>
		<div class="moviePic">
	...
	<div id="greatMovieText">
		Find great movie recommendations!
	</div>
